...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        Schema::create('pmb_pendaftaran', function (Blueprint $table) {
            ...
            $table->foreign('orgunit_diterima_id')->references('orgunit_id')->on('hr_struktur_organisasi')->onDelete('set null');
        ...
        Schema::create('pmb_pilihan_prodi', function (Blueprint $table) {
            ...
            $table->foreign('orgunit_id')->references('orgunit_id')->on('hr_struktur_organisasi');
