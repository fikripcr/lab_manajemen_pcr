...
return new class extends Migration
{
    public function up(): void
    {
        ...
        Schema::create('pemutu_dokumen', function (Blueprint $table) {
            ...
            // Changed from ENUM to VARCHAR for flexibility
        ...
        // Add FK for dokumen -> doksub now that both exist
        ...
        \Illuminate\Support\Facades\DB::statement("
            ...
            LEFT JOIN hr_pegawai p ON pip.pegawai_id = p.pegawai_id
            ...
            LEFT JOIN hr_struktur_organisasi so ON rp.org_unit_id = so.orgunit_id
