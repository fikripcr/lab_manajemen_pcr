...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        Schema::create('lab_jadwal_kuliah', function (Blueprint $table) {
            ...
            $table->foreign('semester_id')->references('semester_id')->on('akademik_semesters');
            $table->foreign('mata_kuliah_id')->references('mata_kuliah_id')->on('akademik_mata_kuliahs');
        ...
        Schema::create('lab_periode_softrequest', function (Blueprint $table) {
            ...
            $table->foreign('semester_id')->references('semester_id')->on('akademik_semesters')->onDelete('cascade');
        });
        ...
        Schema::create('lab_request_software_mata_kuliah', function (Blueprint $table) {
            ...
            $table->foreign('mata_kuliah_id', 'fk_req_soft_mk_mk')->references('mata_kuliah_id')->on('akademik_mata_kuliahs')->onDelete('cascade');
