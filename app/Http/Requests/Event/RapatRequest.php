...
class RapatRequest extends BaseRequest
{
    public function rules(): array
    {
        return [
            ...
            // Optional entitas linking
            'entitas_type' => 'nullable|string',
            'entitas_id' => 'nullable|string',
    ...
    protected function prepareForValidation()
    {
        $this->merge([
            ...
            'entitas_id' => $this->entitas_id ? decryptIdIfEncrypted($this->entitas_id, false) : null,
        ]);
    }
