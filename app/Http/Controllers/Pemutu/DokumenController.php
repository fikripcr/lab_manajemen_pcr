...
use App\Models\Pemutu\Dokumen; // Still needed for model binding or specific view logic? Service returns models.
...
class DokumenController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('pages.pemutu.dokumens.index', compact('pageTitle', 'dokumentByJenis', 'periods'));
    }
    ...
    public function store(DokumenRequest $request)
    {
        try {
            ...
            $redirectUrl = route('pemutu.dokumens.index');
    ...
    public function edit($id)
    {
        ...
        return view('pages.pemutu.dokumens.edit', compact('dokumen', 'dokumens'));
    }
    ...
    public function destroy($id)
    {
        try {
            $dokumen     = $this->dokumenService->getDokumenById($id);
            $redirectOpt = route('pemutu.dokumens.index');
        ...
        try {
            ...
            return DataTables::of($query)
                ...
                ->addColumn('action', function ($row) {
                    ...
                    $deleteUrl = route('pemutu.dokumens.destroy', $row->dok_id); // Ensure destroy uses id
