...
class PublicPageController extends Controller
{
    ...
    {
        return view('pages.cms.public-page.index');
    }
    ...
    {
        return view('pages.cms.public-page.show', ['page' => $publicPage]);
    }
    ...
    {
        return view('pages.cms.public-page.create-edit', ['page' => $publicPage]);
    }
