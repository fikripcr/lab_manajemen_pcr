...
class RiwayatStrukturalController extends Controller
{
    ...
    {
        $units = $this->strukturalService->getStrukturalUnits();
    ...
    {
        $units = $this->strukturalService->getMassStrukturalUnits();
    ...
    {
        $data = $this->strukturalService->getMassAssignments($unitId);

        return view('pages.hr.pegawai._mass_struktural_detail', $data);
    }
    ...
    {
        $query = $this->strukturalService->getDataQuery($request->all());
