...
>
    <div class="row">
        ...
        <div class="col-md-6 mb-3">
            <x-tabler.form-input name="no_sk" label="Nomor SK" value="{{ $inpassing->no_sk }}" placeholder="Nomor SK" required="true" />
        </div>
        <div class="col-md-6 mb-3">
        ...
        <div class="col-md-6 mb-3">
            <x-tabler.form-input name="gaji_pokok" type="number" label="Gaji Pokok" value="{{ $inpassing->gaji_pokok }}" placeholder="Contoh: 3000000" />
        </div>
         <div class="col-md-6 mb-3">
            <x-tabler.form-input name="masa_kerja_tahun" type="number" label="Masa Kerja (Tahun)" value="{{ $inpassing->masa_kerja_tahun }}" placeholder="Tahun" />
        </div>
        <div class="col-md-6 mb-3">
            <x-tabler.form-input name="masa_kerja_bulan" type="number" label="Masa Kerja (Bulan)" value="{{ $inpassing->masa_kerja_bulan }}" placeholder="Bulan" />
        </div>
         <div class="col-md-6 mb-3">
        ...
        <x-tabler.form-textarea name="keterangan" label="Keterangan" rows="3" :value="$inpassing->keterangan" placeholder="Keterangan tambahan..." />
    </div>
</x-tabler.form-modal>
