...
@section('header')
    <x-tabler.page-header title="Manajemen Personil" pretitle="Master Data">
        <x-slot:actions>
            <x-tabler.button type="create" :href="route('hr.personil.create')" class="d-none d-sm-inline-block ajax-modal-btn" text="Tambah Personil" />
        </x-slot:actions>
