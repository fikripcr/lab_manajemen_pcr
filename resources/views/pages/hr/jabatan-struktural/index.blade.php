...
<x-tabler.page-header title="Data Jabatan Struktural" pretitle="Master Data HR">
    <x-slot:actions>
        <x-tabler.button type="create" text="Tambah Data" class="ajax-modal-btn" data-url="{{ route('hr.jabatan-struktural.create') }}" data-modal-title="Tambah Jabatan Struktural" />
    </x-slot:actions>
