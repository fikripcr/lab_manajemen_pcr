...
<x-tabler.page-header title="{{ $pageTitle }}" pretitle="E-Office Master">
    <x-slot:actions>
        <x-tabler.button type="button" icon="ti ti-plus" text="Tambah Layanan" class="btn-primary ajax-modal-btn" 
            data-url="{{ route('eoffice.jenis-layanan.create') }}" data-modal-title="Tambah Jenis Layanan Baru" />
    </x-slot:actions>
