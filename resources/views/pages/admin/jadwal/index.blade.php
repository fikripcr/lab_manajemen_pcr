...
<x-tabler.page-header title="Jadwal Kuliah" pretitle="Perkuliahan">
    <x-slot:actions>
        ...
        <x-tabler.button type="create" :href="route('jadwal.create')" text="Create" />
    </x-slot:actions>
        ...
        <div class="card-body p-0">
            ...
            <x-tabler.datatable 
                ...
                :columns="[
                    ...
                    ['title' => 'Waktu Mulai', 'data' => 'waktu_mulai', 'name' => 'waktu_mulai'],
                    ['title' => 'Waktu Selesai', 'data' => 'waktu_selesai', 'name' => 'waktu_selesai'],
                    ['title' => 'Mata Kuliah', 'data' => 'mata_kuliah_nama', 'name' => 'mata_kuliahs.nama_mk'],
                    ['title' => 'Dosen', 'data' => 'dosen_nama', 'name' => 'users.name'],
                    ['title' => 'Lab', 'data' => 'ruang_nama', 'name' => 'labs.name'],
                    ['title' => 'Semester', 'data' => 'semester_nama_display', 'name' => 'semesters.tahun_ajaran'],
