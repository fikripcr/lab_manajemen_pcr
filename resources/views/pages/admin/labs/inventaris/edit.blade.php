...
@section('header')
    <x-sys.page-header :title="'Edit Inventaris Lab: ' . $labInventaris->kode_inventaris" pretitle="Laboratorium">
        <x-slot:actions>
            <x-sys.button type="back" :href="route('labs.inventaris.index', $labInventaris->encrypted_lab_id)" />
        </x-slot:actions>
    </x-sys.page-header>
@endsection
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <form action="{{ route('labs.inventaris.update', [$labInventaris->encrypted_lab_id, $labInventaris->encrypted_id]) }}" method="POST" class="ajax-form">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="row mt-4">
                            <div class="col-sm-10 offset-sm-2">
                                <x-sys.button type="submit" text="Simpan Perubahan" />
                                <x-sys.button type="cancel" :href="route('labs.inventaris.index', $labInventaris->encrypted_lab_id)" />
                            </div>
                        </div>
                    </form>
                </div>
