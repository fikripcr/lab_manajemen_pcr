...
@section('header')
    <x-tabler.page-header :title="'Edit Inventaris Lab: ' . $labInventaris->kode_inventaris" pretitle="Laboratorium">
        <x-slot:actions>
            <x-tabler.button type="back" :href="route('labs.inventaris.index', $labInventaris->encrypted_lab_id)" />
        </x-slot:actions>
                    ...
                    <form action="{{ route('labs.inventaris.update', [$labInventaris->encrypted_lab_id, $labInventaris->encrypted_id]) }}" method="POST" class="ajax-form">
                        ...
                        <div class="row mt-4">
                            <div class="col-sm-10 offset-sm-2">
                                ...
                                <x-tabler.button type="cancel" :href="route('labs.inventaris.index', $labInventaris->encrypted_lab_id)" />
                            </div>
                        </div>
                    </form>
                </div>
