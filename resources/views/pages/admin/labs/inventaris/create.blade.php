...
@section('header')
    <x-sys.page-header :title="'Tambah Inventaris ke Lab: ' . $lab->name" pretitle="Laboratorium">
        <x-slot:actions>
            <x-sys.button type="back" :href="route('labs.inventaris.index', $lab->encrypted_lab_id)" />
        </x-slot:actions>
    </x-sys.page-header>
@endsection
                    ...
                    <form action="{{ route('labs.inventaris.store', $lab->encrypted_lab_id) }}" method="POST" class="ajax-form">
                        ...
                        <div class="row mt-4">
                            <div class="col-sm-10 offset-sm-2">
                                ...
                                <x-sys.button type="cancel" :href="route('labs.inventaris.index', $lab->encrypted_lab_id)" />
                            </div>
                        </div>
                    </form>
                </div>
