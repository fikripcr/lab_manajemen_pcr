                    ...
                    <div class="col-sm-12 col-md-6 d-flex justify-content-md-end">
                        <div class="dt-search">
                            <form method="GET" action="{{ route('labs.index') }}" class="d-flex">
                                <input type="text" name="search" value="{{ request('search') }}" placeholder="Search labs by name, location or description..." class="form-control form-control-sm" aria-controls="labs-table">
                        ...
                        <tbody class="table-border-bottom-0">
                            @forelse ($labs as $lab)
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex">
                                            <a href="{{ route('labs.show', $lab) }}" class="text-primary dropdown-item">
                                                <i class="bx bx-show me-1"></i> View
                                            </a>
                                            <a href="{{ route('labs.edit', $lab) }}" class="text-primary dropdown-item">
                                                <i class="bx bx-edit me-1"></i> Edit
                                            </a>
                                            <form action="{{ route('labs.destroy', $lab) }}" method="POST" class="d-inline">
                                                @csrf
                                                @method('DELETE')
                                                <button type="submit" class="text-danger dropdown-item" onclick="return confirm('Are you sure you want to delete this lab? All related data will be affected.')">
                    ...
                    <div class="col-sm-12 col-md-7 d-flex justify-content-md-end">
                        <nav aria-label="Page navigation">
                            <ul class="pagination">
                                ...
                                @else
                                    <li class="page-item first">
                                        <a class="page-link" href="{{ $labs->url(1) }}"><i class="tf-icon bx bx-chevrons-left"></i></a>
                                    </li>
                                    <li class="page-item prev">
                                        <a class="page-link" href="{{ $labs->previousPageUrl() }}"><i class="tf-icon bx bx-chevron-left"></i></a>
                                    </li>
                                @endif
                                ...
                                @if ($labs->hasMorePages())
                                    <li class="page-item next">
                                        <a class="page-link" href="{{ $labs->nextPageUrl() }}"><i class="tf-icon bx bx-chevron-right"></i></a>
                                    </li>
                                    <li class="page-item last">
                                        <a class="page-link" href="{{ $labs->url($labs->lastPage()) }}"><i class="tf-icon bx bx-chevrons-right"></i></a>
                                    </li>
                                @else
                                    <li class="page-item next">
