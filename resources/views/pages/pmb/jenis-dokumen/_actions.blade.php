<div class="btn-group">
    <x-tabler.button type="button" class="btn-sm btn-info ajax-modal-btn"
        ...
        data-url="{{ route('pmb.jenis-dokumen.edit', $d->encrypted_jenis_dokumen_id) }}" icon="ti ti-edit" />
        
    <x-tabler.button type="button" class="btn-sm btn-danger ajax-delete"
        data-url="{{ route('pmb.jenis-dokumen.destroy', $d->encrypted_jenis_dokumen_id) }}"
