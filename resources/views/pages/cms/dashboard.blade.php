...
@section('content')
        <div class="row row-cards">
            ...
            <div class="col-12">
                <x-tabler.card id="carousel-slideshow" class="carousel slide shadow-sm border-0" data-bs-ride="carousel" style="border-radius: 12px; overflow: hidden;">
                    ...
                    <x-tabler.card-body class="d-flex align-items-center py-5 position-relative">
                        ...
                        <div class="flex-grow-1">
                            ...
                            <div class="d-flex flex-wrap gap-2 mt-3">
                                ...
                                <x-tabler.button href="{{ route('cms.pengumuman.index') }}" style="outline-light" class="px-4 py-2" text="Pusat Pengumuman" icon="ti ti-news" />
                            </div>
                        </div>
