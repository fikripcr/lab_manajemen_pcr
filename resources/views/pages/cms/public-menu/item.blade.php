<li class="list-group-item" data-id="{{ $menu->encrypted_menu_id }}">
    <div class="d-flex justify-content-between align-items-center">
        ...
        <div class="btn-list">
            <x-tabler.button 
                ...
                data-url="{{ route('cms.public-menu.edit', $menu->encrypted_menu_id) }}"
            ...
            <x-tabler.button 
                ...
                data-url="{{ route('cms.public-menu.destroy', $menu->encrypted_menu_id) }}"
    ...
    <ul class="list-group list-group-flush sortable-list mt-2">
        @foreach($menu->children as $child)
            @include('pages.cms.public-menu.item', ['menu' => $child])
        @endforeach
    </ul>
</li>
