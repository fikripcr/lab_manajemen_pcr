            ...
            @foreach($slideshows as $slide)
                <div class="col-md-6 col-lg-4" data-id="{{ $slide->encrypted_slideshow_id }}">
                    <x-tabler.card class="card-sm">
                        ...
                        <x-tabler.card-footer class="d-flex py-3">
                            ...
                            <div class="btn-list">
                                <x-tabler.button 
                                    ...
                                    icon="ti ti-pencil" 
                                    data-url="{{ route('cms.slideshow.edit', $slide->encrypted_slideshow_id) }}"
                                ...
                                <x-tabler.button 
                                    ...
                                    icon="ti ti-trash" 
                                    data-url="{{ route('cms.slideshow.destroy', $slide->encrypted_slideshow_id) }}"
