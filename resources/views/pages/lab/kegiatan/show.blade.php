                ...
                <div class="card mt-3">
                    ...
                    <div class="table-responsive">
                        <table class="table table-vcenter card-table">
                            ...
                            <tbody>
                                @forelse($kegiatan->approvals as $approval)
                                    <tr>
                                        ...
                                        <td>
                                            @php
                                                ...
                                                $historyColor = $historyBadges[$approval->status] ?? 'secondary';
                                            @endphp
                                            <span class="badge bg-{{ $historyColor }}">{{ ucfirst($approval->status) }}</span>
                                        </td>
