...
<x-tabler.page-header title="Master Personil" pretitle="Master Data">
    <x-slot:actions>
        <x-tabler.button type="create" class="ajax-modal-btn" :modal-url="route('hr.personil.create')" modal-title="Tambah Personil" />
    </x-slot:actions>
...
@section('content')
    <x-tabler.card>
        ...
        <x-tabler.card-body class="p-0">
            <x-tabler.datatable
                id="personil-table" route="{{ route('hr.personil.data') }}" :columns="[
                [
                    'title' => 'NIP/NIK',
                    'data' => 'nip',
                    'name' => 'nip',
