@if(request()->ajax() || request()->has('ajax'))
    <x-tabler.form-modal
        title="Ubah Lab"
        route="{{ route('lab.labs.update', $lab->encrypted_lab_id) }}"
        method="PUT"
    ...
    >
        ...
        <x-tabler.form-textarea type="editor" id="description_edit_modal" name="description" label="Description" :value="old('description', $lab->description)" height="300" />

        <!-- Media Upload Section -->
        <x-tabler.form-input type="file" name="lab_images[]" id="lab_images_edit_modal" label="Upload New Images" class="filepond-input" multiple data-allow-multiple="true" accept="image/*" help="Upload new photos to add to this lab." />
