...
<x-tabler.page-header title="Semester" pretitle="Perkuliahan">
    <x-slot:actions>
        <x-tabler.button type="create" class="ajax-modal-btn" :modal-url="route('akademik.semesters.create-modal')" modal-title="Tambah Semester" />
    </x-slot:actions>
...
@section('content')
    <x-tabler.card class="overflow-hidden">
        ...
        <x-tabler.card-body class="p-0">
            <x-tabler.datatable
                id="semesters-table"
                :route="route('akademik.semesters.data')"
                :columns="[
