@if(request()->ajax() || request()->has('ajax'))
    <x-tabler.form-modal title="Semester Details" method="none">
        ...
        <x-slot:footer>
            ...
            <x-tabler.button type="edit" :href="route('akademik.semesters.edit', $semester->encrypted_semester_id)" class="ms-auto" />
        </x-slot:footer>
    </x-tabler.form-modal>
@else
    ...
    @section('header')
        <x-tabler.page-header title="Semester Details">
            <x-slot:actions>
                <x-tabler.button type="back" :href="route('akademik.semesters.index')" />
            </x-slot:actions>
    ...
    @section('content')
                        ...
                        <div class="mt-4 pt-3 border-top">
                            <form method="POST" action="{{ route('akademik.semesters.destroy', $semester->encrypted_semester_id) }}">
                                @csrf
                                @method('DELETE')
