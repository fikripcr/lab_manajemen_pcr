<x-tabler.form-modal
    ...
    route="{{ $semester->exists ? route('akademik.semesters.update', $semester->encrypted_semester_id) : route('akademik.semesters.store') }}"
...
>
    ...
    <div class="mb-3">
        <x-tabler.form-input type="date" name="start_date" id="start_date" label="Tanggal Mulai" :value="old('start_date', $semester->start_date)" required="true" />
    </div>

    <div class="mb-3">
        <x-tabler.form-input type="date" name="end_date" id="end_date" label="Tanggal Selesai" :value="old('end_date', $semester->end_date)" required="true" />
    </div>
