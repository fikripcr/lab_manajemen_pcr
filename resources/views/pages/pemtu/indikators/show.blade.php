...
@section('header')
<x-tabler.page-header title="Detail Indikator" pretitle="SPMI" :back-url="route('pemtu.dok-subs.show', $indikator->doksub_id)">
    <x-slot:actions>
        <x-tabler.button type="a" href="{{ route('pemtu.indikators.edit', $indikator->indikator_id) }}" icon="ti ti-pencil" text="Edit Indikator" class="btn-primary" />
    </x-slot:actions>
        ...
        <div class="card">
            ...
            <div class="list-group list-group-flush">
                @forelse($indikator->relatedDokSubs as $relSub)
                    <a href="{{ route('pemtu.dok-subs.show', $relSub->doksub_id) }}" class="list-group-item list-group-item-action d-flex align-items-center">
                        <div>
