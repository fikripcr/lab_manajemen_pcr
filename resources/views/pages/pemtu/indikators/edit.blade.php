    ...
    <div class="page-header d-print-none">
        <div class="row g-2 align-items-center">
            ...
            <div class="col-auto ms-auto d-print-none">
                <a href="{{ route('pemtu.indikators.show', $indikator->indikator_id) }}" class="btn btn-secondary">
...
<div class="page-body">
    <div class="container-xl">
        <form action="{{ route('pemtu.indikators.update', $indikator->indikator_id) }}" method="POST" class="card ajax-form">
            @csrf
            @method('PUT')
