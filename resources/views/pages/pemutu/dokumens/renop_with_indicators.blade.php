    ...
    <div class="modal-body">
        ...
        <div class="card-table">
            ...
            @if($indicators->isEmpty())
                <div class="text-center text-muted p-4">Belum ada indikator.</div>
            @endif
        </div>
    </div>
    <div class="modal-footer">
        <x-tabler.button type="cancel" data-bs-dismiss="modal" text="Tutup" />
        <x-tabler.button :href="route('pemutu.dokumens.show', $dokumen->dok_id)" text="Detail Dokumen" />
    </div>
@else
