...
@section('header')
    <div class="row g-2 align-items-center">
        <div class="col">
            ...
            <div class="text-muted mt-1">Pemutu / Meeting / Entitas / Edit</div>
        </div>
        <div class="col-auto ms-auto d-print-none">
            <div class="btn-list">
                <a href="{{ route('pemutu.rapat.show', $entitas->rapat) }}" class="btn btn-secondary d-none d-sm-inline-block">
...
@section('content')
    <div class="card">
        ...
        <div class="card-body">
            ...
            <form class="ajax-form" action="{{ route('pemutu.rapat.entitas.update', $entitas) }}" method="POST">
                @csrf
                @method('PUT')
                ...
                <div class="d-flex justify-content-end gap-2 mt-4">
                    <a href="{{ route('pemutu.rapat.show', $entitas->rapat) }}" class="btn btn-secondary">
                        <i class="ti ti-arrow-left me-1"></i>
                        Batal
                    </a>
