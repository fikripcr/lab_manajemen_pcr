            ...
            <div class="d-flex justify-content-center mb-4">
                <div class="col-12 col-lg-8">
                    <div class="position-relative">
                        ...
                        <input
                            type="text"
                            class="form-control ps-5 fs-5 py-3 border-2 search-input"
                            placeholder="Search across all system functions..."
                            aria-label="Search across all system functions..."
            ...
            <div class="row g-4">
                ...
                <div class="col-md-6 col-lg-4">
                    <div class="d-flex align-items-center p-3 bg-white rounded hover-pointer"
                         onclick="window.location='{{ route('activity-log.index') }}'">
                        <div class="avatar me-3">
                            <div class="avatar-initial rounded-circle bg-transparent text-primary">
                                <i class="bx bx-history bx-lg"></i>
                            </div>
                ...
                <div class="col-md-6 col-lg-4">
                    <div class="d-flex align-items-center p-3 bg-white rounded hover-pointer"
                         onclick="window.location='{{ route('app-config') }}'">
                        <div class="avatar me-3">
                            <div class="avatar-initial rounded-circle bg-transparent text-warning">
                ...
                <div class="col-md-6 col-lg-4">
                    <div class="d-flex align-items-center p-3 bg-white rounded hover-pointer"
                         onclick="window.location='{{ route('admin.backup.index') }}'">
                        <div class="avatar me-3">
                            <div class="avatar-initial rounded-circle bg-transparent text-info">
                ...
                <div class="col-md-6 col-lg-4">
                    <div class="d-flex align-items-center p-3 bg-white rounded hover-pointer"
                         onclick="window.location='{{ route('notifications.index') }}'">
                        <div class="avatar me-3">
                ...
                <div class="col-md-6 col-lg-4">
                    <div class="d-flex align-items-center p-3 bg-white rounded hover-pointer"
                         onclick="window.location='{{ route('admin.documentation') }}'">
                        <div class="avatar me-3">
