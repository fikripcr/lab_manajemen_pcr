...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        $(document).on('change', '.toggle-status', function() {
            ...
            // Note: Route for toggle status needed in Shared controller
            // Assuming shared.struktur-organisasi.toggle-status exists
        });
        ...
        $('#filter-type, #filter-status').on('change', function() {
            ...
            var url = '{{ route("shared.struktur-organisasi.index") }}?type=' + type + '&status=' + status;
