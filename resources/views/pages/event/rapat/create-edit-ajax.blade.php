                ...
                <div class="card-body">
                    ...
                    <form class="ajax-form" action="{{ $rapat->exists ? route('Kegiatan.rapat.update', $rapat->encrypted_rapat_id) : route('Kegiatan.rapat.store') }}" method="POST">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <x-tabler.form-input 
                                    ...
                                    label="Tanggal Rapat" 
                                    type="date" 
                                    value="{{ old('tgl_rapat', $rapat->exists ? $rapat->tgl_rapat?->format('Y-m-d') : '') }}"
                                    required="true" 
                                />
                            </div>
                            <div class="col-md-3">
                        ...
                        <div class="d-flex justify-content-end gap-2 mt-4">
                            ...
                            <x-tabler.button type="submit" :text="$rapat->exists ? 'Simpan Perubahan' : 'Jadwalkan'" />
                        </div>
                    </form>
                </div>
            </div>
                        ...
                        >
                            @foreach($rapat->entitas as $entitas)
                                <tr>
                                    ...
                                    <td>
                                        <div class="btn-list">
                                            <x-tabler.button type="edit" class="btn-sm" href="{{ route('Kegiatan.rapat.entitas.edit', $entitas->encrypted_rapatentitas_id) }}" text="Edit" />
                                        </div>
                                    </td>
                                </tr>
                            @endforeach
