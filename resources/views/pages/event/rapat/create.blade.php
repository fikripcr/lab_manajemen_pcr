...
@section('header')
    <div class="row g-2 align-items-center">
        <div class="col">
            ...
            <div class="text-muted mt-1">Kegiatan / Meeting / Jadwalkan</div>
        </div>
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">Form Jadwalkan Meeting</h3>
                </div>
                <div class="card-body">
                    <x-tabler.flash-message />

                    <form class="ajax-form" action="{{ route('Kegiatan.rapat.store') }}" method="POST">
                        @csrf
                        ...
                        <div class="d-flex justify-content-end gap-2 mt-4">
                            ...
                            <x-tabler.button type="submit" text="Jadwalkan" />
                        </div>
                    </form>
                </div>
            </div>
