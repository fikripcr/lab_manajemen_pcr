            ...
            <div class="col-lg-6 hero-images" data-aos="fade-left" data-aos-delay="400">
              <div class="image-stack">
                <div class="main-image">
                  <img src="{{asset('assets-guest')}}/img/real-estate/property-exterior-3.webp" alt="Luxury Property" class="img-fluid">
                ...
                <div class="secondary-image">
                  <img src="{{asset('assets-guest')}}/img/real-estate/property-interior-7.webp" alt="Property Interior" class="img-fluid">
                </div>

                <div class="floating-card">
                  <div class="agent-info">
                    <img src="{{asset('assets-guest')}}/img/real-estate/agent-4.webp" alt="Agent" class="agent-avatar">
          ...
          <div class="col-lg-6 order-lg-2" data-aos="fade-left" data-aos-delay="200">
            <div class="image-section">
              <div class="main-image-wrapper">
                <img src="{{asset('assets-guest')}}/img/real-estate/property-exterior-7.webp" alt="Premium Property" class="img-fluid main-image">
                <div class="floating-card">
              ...
              <div class="secondary-images">
                <div class="small-image">
                  <img src="{{asset('assets-guest')}}/img/real-estate/property-interior-8.webp" alt="Interior Design" class="img-fluid">
                </div>
                <div class="small-image">
                  <img src="{{asset('assets-guest')}}/img/real-estate/agent-3.webp" alt="Expert Agent" class="img-fluid">
                </div>
              </div>
            </div>
          </div>
      ...
      <div class="container" data-aos="fade-up" data-aos-delay="100">
          ...
          <article class="highlight-card">
            <div class="media">
              ...
              <a href="property-details.html" class="image-link">
                <img src="{{asset('assets-guest')}}/img/real-estate/property-exterior-6.webp" alt="Showcase Villa" class="img-fluid">
              </a>
          ...
          <div class="mini-list">
            ...
            <article class="mini-card" data-aos="fade-up" data-aos-delay="200">
              <a href="property-details.html" class="thumb">
                <img src="{{asset('assets-guest')}}/img/real-estate/property-interior-2.webp" alt="Loft Haven" class="img-fluid" loading="lazy">
            ...
            <article class="mini-card" data-aos="fade-up" data-aos-delay="250">
              <a href="property-details.html" class="thumb">
                <img src="{{asset('assets-guest')}}/img/real-estate/property-exterior-3.webp" alt="Suburban Home" class="img-fluid" loading="lazy">
            ...
            <article class="mini-card" data-aos="fade-up" data-aos-delay="300">
              <a href="property-details.html" class="thumb">
                <img src="{{asset('assets-guest')}}/img/real-estate/property-interior-7.webp" alt="Penthouse" class="img-fluid" loading="lazy">
        ...
        <div class="row gy-4 mt-4">
          ...
          <div class="col-lg-4" data-aos="fade-up" data-aos-delay="300">
            <article class="stack-card">
              <figure class="stack-media">
                <img src="{{asset('assets-guest')}}/img/real-estate/property-exterior-8.webp" alt="Modern Facade" class="img-fluid" loading="lazy">
                <figcaption>
          ...
          <div class="col-lg-4" data-aos="fade-up" data-aos-delay="350">
            <article class="stack-card">
              <figure class="stack-media">
                <img src="{{asset('assets-guest')}}/img/real-estate/property-interior-10.webp" alt="Cozy Interior" class="img-fluid" loading="lazy">
                <figcaption>
          ...
          <div class="col-lg-4" data-aos="fade-up" data-aos-delay="400">
            <article class="stack-card">
              <figure class="stack-media">
                <img src="{{asset('assets-guest')}}/img/real-estate/property-exterior-10.webp" alt="Garden Home" class="img-fluid" loading="lazy">
                <figcaption>
      ...
      <div class="container" data-aos="fade-up" data-aos-delay="100">
        ...
        <div class="row gy-5 justify-content-center">
          ...
          <div class="col-lg-6 col-xl-4" data-aos="fade-up" data-aos-delay="100">
            <div class="agent-card">
              <div class="agent-image">
                <img src="{{asset('assets-guest')}}/img/real-estate/agent-5.webp" alt="Top Agent" class="img-fluid">
          ...
          <div class="col-lg-6 col-xl-4" data-aos="fade-up" data-aos-delay="200">
            <div class="agent-card">
              <div class="agent-image">
                <img src="{{asset('assets-guest')}}/img/real-estate/agent-4.webp" alt="Top Agent" class="img-fluid">
                <div class="agent-overlay">
                  <div class="contact-buttons">
          ...
          <div class="col-lg-6 col-xl-4" data-aos="fade-up" data-aos-delay="300">
            <div class="agent-card">
              <div class="agent-image">
                <img src="{{asset('assets-guest')}}/img/real-estate/agent-8.webp" alt="Top Agent" class="img-fluid">
                <div class="agent-overlay">
                  <div class="contact-buttons">
        ...
        <div class="row align-items-center gy-5">
          ...
          <div class="col-lg-5" data-aos="fade-right" data-aos-delay="200">
            <div class="image-showcase">
              <div class="main-image-wrapper">
                <img src="{{asset('assets-guest')}}/img/real-estate/property-exterior-3.webp" alt="Premium Property" class="img-fluid main-image">
        ...
        <div class="row gy-5">
          ...
          <div class="col-xl-4 col-md-6" data-aos="fade-up" data-aos-delay="100">
            <div class="post-item position-relative h-100">
              ...
              <div class="post-img position-relative overflow-hidden">
                <img src="{{asset('assets-guest')}}/img/blog/blog-post-1.webp" class="img-fluid" alt="">
          ...
          <div class="col-xl-4 col-md-6" data-aos="fade-up" data-aos-delay="200">
            <div class="post-item position-relative h-100">
              ...
              <div class="post-img position-relative overflow-hidden">
                <img src="{{asset('assets-guest')}}/img/blog/blog-post-2.webp" class="img-fluid" alt="">
          ...
          <div class="col-xl-4 col-md-6" data-aos="fade-up" data-aos-delay="300">
            <div class="post-item position-relative h-100">
              ...
              <div class="post-img position-relative overflow-hidden">
                <img src="{{asset('assets-guest')}}/img/blog/blog-post-3.webp" class="img-fluid" alt="">
        ...
        <div class="row align-items-center">
          ...
          <div class="col-lg-6 order-1 order-lg-2" data-aos="fade-left" data-aos-delay="250">
            ...
            <div class="cta-visual">
              <div class="main-image">
                <img src="{{asset('assets-guest')}}/img/real-estate/property-exterior-5.webp" alt="Property Investment" class="img-fluid">
